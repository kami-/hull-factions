		...
		class Item0
		{
			...
			class Vehicles
			{
				...
				class Item0
				{
					...
					id=0;
					side="WEST";
					vehicle="usm_marine_80s_w_h_snco";
					player="PLAY CDG";
					leader=1;
					rank="LIEUTENANT";
					skill=0.5;
				...
				class Item1
				{
					...
					id=1;
					side="WEST";
					vehicle="usm_marine_80s_w_h_medic";
					player="PLAY CDG";
					rank="CORPORAL";
					skill=0.5;
		...
		class Item1
		{
			...
			class Vehicles
			{
				...
				class Item0
				{
					...
					id=2;
					side="WEST";
					vehicle="usm_marine_80s_w_h_nco";
					player="PLAY CDG";
					leader=1;
					rank="LIEUTENANT";
					skill=0.5;
		...
		class Item3
		{
			...
			class Vehicles
			{
				...
				class Item0
				{
					...
					id=6;
					side="WEST";
					vehicle="usm_marine_80s_w_h_ftl";
					player="PLAY CDG";
					leader=1;
					rank="CORPORAL";
					skill=0.5;
				...
				class Item2
				{
					...
					id=8;
					side="WEST";
					vehicle="usm_marine_80s_w_h_rm1";
					player="PLAY CDG";
					skill=0.5;
				...
				class Item3
				{
					...
					id=9;
					side="WEST";
					vehicle="usm_marine_80s_w_h_at4";
					player="PLAY CDG";
					skill=0.5;
		...
		class Item6
		{
			...
			class Vehicles
			{
				...
				class Item1
				{
					...
					id=19;
					side="WEST";
					vehicle="usm_marine_80s_w_h_off";
					player="PLAY CDG";
					rank="CORPORAL";
					skill=0.5;
		...
		class Item18
		{
			...
			class Vehicles
			{
				...
				class Item1
				{
					...
					id=71;
					side="WEST";
					vehicle="usm_marine_80s_w_h_mgab";
					player="PLAY CDG";
					skill=0.5;
		...
		class Item20
		{
			...
			class Vehicles
			{
				...
				class Item0
				{
					...
					id=74;
					side="WEST";
					vehicle="usm_marine_80s_w_h_jav";
					player="PLAY CDG";
					leader=1;
					rank="CORPORAL";
					skill=0.5;
				...
				class Item1
				{
					...
					id=75;
					side="WEST";
					vehicle="usm_marine_80s_w_h_ajav";
					player="PLAY CDG";
					skill=0.5;
		...
		class Item27
		{
			...
			class Vehicles
			{
				...
				class Item0
				{
					...
					id=93;
					side="WEST";
					vehicle="usm_marine_80s_w_h_crew1";
					player="PLAY CDG";
					leader=1;
					rank="CORPORAL";
					skill=0.5;
		...
		class Item35
		{
			...
			class Vehicles
			{
				...
				class Item0
				{
					...
					id=125;
					side="WEST";
					vehicle="usm_marine_80s_w_l_crew1";
					player="PLAY CDG";
					leader=1;
					rank="CORPORAL";
					skill=0.5;
